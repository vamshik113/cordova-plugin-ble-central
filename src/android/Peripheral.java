...
public class Peripheral extends BluetoothGattCallback {
    ...
    /**
     * Uses reflection to refresh the device cache. This *might* be helpful if a
     * peripheral changes services or characteristics and does not correctly
     * implement Service Changed 0x2a05 on Generic Attribute Service 0x1801.
     *
    ...
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        ...
        // refreshCallback is a kludge for refreshing services, if it exists, it
        // temporarily
        // overrides the connect callback. Unfortunately this edge case make the code
        // confusing.
    ...
    private void removeNotifyCallback(CallbackContext callbackContext, UUID serviceUUID, UUID characteristicUUID) {
        ...
        if (characteristic != null) {
            ...
            if (gatt.setCharacteristicNotification(characteristic, false)) {
                ...
                // TODO we can probably ignore and return success anyway since we removed the
    ...
    public void upgradeFirmware(CallbackContext callbackContext, Uri uri) {
        ...
        final DfuServiceInitiator starter = new DfuServiceInitiator(device.getAddress()).setDeviceName(device.getName())
                .setKeepBond(false).setForceDfu(false).setPacketsReceiptNotificationsEnabled(true)
                .setPacketsReceiptNotificationsValue(10).setUnsafeExperimentalButtonlessServiceInSecureDfuEnabled(true)
